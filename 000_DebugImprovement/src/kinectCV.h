...
class KinectCV{
  ...
  const bool BinaryDisplay(void);
        void BinaryDisplay(const bool _binarydisplay);
...
/* =============================================================== *
 * const bool BinaryDisplay(void);                                 *
 *       void BinaryDisplay(const bool _displaymode);              *
 * =============================================================== */
inline const bool KinectCV :: BinaryDisplay(void)                   { return binarydisplay; }
inline       void KinectCV :: BinaryDisplay(const bool _displaymode){ binarydisplay = _displaymode; }
...
inline bool KinectCV :: update(void){
  ...
  if(kinect.isFrameNew()){
    ...
    grayImage.setFromPixels( grayImage.getRoiPixels(), cliparea.getWidth(), cliparea.getHeight() );
...
inline void KinectCV :: draw(void){
  ...
  ofDrawRectangle(           10, Size().y - 20, 10, 10);
  ofDrawRectangle(Size().x - 20,            10, 10, 10);
  ofDrawRectangle(Size().x - 20, Size().y - 20, 10, 10);
